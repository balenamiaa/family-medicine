...
- UI must feel smooth, fast, pre-rendered, high-contrast, and professional; optimize for mobile-first ergonomics.
- Favor compact, high-signal interfaces; remove low-value UI (especially in stats) in favor of clarity and simplicity.
